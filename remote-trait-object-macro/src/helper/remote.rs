...
pub fn generate_remote(source_trait: &syn::ItemTrait) -> Result<TokenStream2, TokenStream2> {
    ...
    imported_struct.extend(quote! {
        ...
        impl #env_path::ImportServiceBox<dyn #trait_ident> for dyn #trait_ident {
            fn import(port: std::sync::Weak<dyn #env_path::Port>, handle: #env_path::HandleToExchange) -> Box<dyn #trait_ident> {
        ...
        impl #env_path::ImportServiceRwLock<dyn #trait_ident> for dyn #trait_ident {
            fn import(port: std::sync::Weak<dyn #env_path::Port>, handle: #env_path::HandleToExchange) -> std::sync::Arc<parking_lot::RwLock<dyn #trait_ident>> {
